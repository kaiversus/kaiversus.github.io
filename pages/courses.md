...
---
<style>
    /* CSS CHO BỘ LỌC (Dùng màu Primary mặc định) */
    .filter-btn {
...
<section class="container" style="margin-top: 50px;">
    ...
    <div class="filter-console" style="margin-top: 30px; border: 1px solid #333; padding: 20px; background: rgba(0,0,0,0.5);">
        ...
        <div style="margin-bottom: 20px; border-bottom: 1px dashed #444; padding-bottom: 20px;">
            ...
            <input type="text" id="searchInput" onkeyup="filterSearch()" placeholder="Search modules..." class="cyber-input" 
                   style="background: transparent; border: none; border-bottom: 1px solid #555; color: var(--primary); font-family: monospace; width: 60%; margin-left: 10px; outline: none;">
        </div>
        ...
        <div class="filter-group" style="margin-top: 15px;">
            <span style="color: var(--accent); font-family: monospace;">> TOPIC_TAGS: </span>
    ...
    <div class="card-grid" style="margin-top: 30px;">
        ...
        <article class="log-card filter-item" 
            ...
            <div class="log-header">
                ...
                {% if post.difficulty %}
                <span style="color: var(--primary); border: 1px solid var(--primary); padding: 0 5px; border-radius: 3px; font-size: 0.7rem;">
            ...
            <div style="text-align: right;">
                <span class="cmd-btn">[ ACCESS_MODULE ]</span>
            </div>
        </article>
        {% endfor %}
    </div>
